        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    <div class="agent-photo">
                        <a href="#">
                            <img src="assets/img/avatar/madhavajpg" alt="madhava" class="img-fluid">
                        </a>
                    </div>
                    <div class="agent-details">
                        <h5><a href="#">madhava</a></h5>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="agent-2">
                    <div class="agent-photo">
                        <a href="#">
                            <img src="assets/img/avatar/abhiram.jpg" alt="abhiram" class="img-fluid">
                        </a>
                    </div>
                    <div class="agent-details">
                        <h5><a href="#">abhiram</a></h5>
                        <p>Office Manager</p>
                        <ul class="social-list clearfix">
                            <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
